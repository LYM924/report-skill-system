...
3. 业务指标数据：`weekly_data.py` 自动从 Confluence 获取（pageId: 286888251，翡翠技术支持业务指标数据），含 UV、咨询量、工单量、完结率、故障等全部指标及上周对比
4. 上周报告参考：读取 `2026报表数据知识库/周报/{上周}-技术支持周报.md`，仅用于简述描述参考和格式对齐
5. **无上周报告时**：较上周列和变化率填"—"，简述中跳过对比描述
